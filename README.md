@tambolishahid/ckeditor5-videouploader
======================================
...
The `@tambolishahid/ckeditor5-videouploader` package is available under [MIT license](https://opensource.org/licenses/MIT).
